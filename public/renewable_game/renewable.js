function initializeGame(){document.addEventListener('DOMContentLoaded', () => {
    ...
    function checkGameEnd() {
        if (cardsContainer.children.length === 0) {
            ...
            showCustomAlert(`Game Over! You have successfully completed this game.`);
        }
    }

    // continueBtn.addEventListener('click', finishGame);
